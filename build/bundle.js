...
/* harmony import */ var _lib_Pipe__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./lib/Pipe */ "./src/lib/Pipe.ts");
/* harmony import */ var _lib_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./lib/core */ "./src/lib/core.ts");
/* harmony import */ var _EnhancedInput__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./EnhancedInput */ "./src/EnhancedInput.ts");
...
class App extends _lib_Pipe__WEBPACK_IMPORTED_MODULE_0__["default"] {
    constructor() {
        super('div', ['app', 'flex-column'], {
            div: new _lib_core__WEBPACK_IMPORTED_MODULE_1__["Div"](['flex-centered'], {
                a: new _EnhancedInput__WEBPACK_IMPORTED_MODULE_2__["default"]().style({
                    'font-family': `'VT323', monospace`,
                    'font-size': '30px'
                }),
                b: new _lib_core__WEBPACK_IMPORTED_MODULE_1__["Div"](['wrapper'], {
                    text: new _lib_core__WEBPACK_IMPORTED_MODULE_1__["Text"]().style({
                        'margin': '0',
                    ...
                    img: new _lib_core__WEBPACK_IMPORTED_MODULE_1__["Image"]().style({
                        'margin': '20px 0 0',
                        'width': '100%',
                        'object-fit': 'contain'
                    })
    ...
    plug() {
        ...
        const json$ = textInput.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(s => fetch('https://yesno.wtf/api')), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(res => res.json()), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["share"])());
        json$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(json => json.image)).subscribe(imageSrc);
        const truncatedInput = textInput.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(t => (t.length > 10 ? '...' : '') + t.slice(-10)));
        Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["combineLatest"])(truncatedInput, json$).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(([text, json]) => `${text} : ${json.answer.padEnd(3, ' ').replace(/\s/g, '&nbsp;')}`)).subscribe(textDisplay);
    }
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return EnhancedInput; });
/* harmony import */ var _lib_Pipe__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./lib/Pipe */ "./src/lib/Pipe.ts");
/* harmony import */ var _lib_core_Input__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./lib/core/Input */ "./src/lib/core/Input.ts");


class EnhancedInput extends _lib_Pipe__WEBPACK_IMPORTED_MODULE_0__["default"] {
    constructor() {
        super('enhanced-input', ['wrapper'], {
            raw: new _lib_core_Input__WEBPACK_IMPORTED_MODULE_1__["default"]().style({
                'border': 'none',
                'outline': 'none',
                'padding': '5px',
                'width': '100%',
...
new _App__WEBPACK_IMPORTED_MODULE_0__["default"]().mount(document.querySelector('#root'));
...
class Pipe {
    constructor(type, classes, children) {
...
/*!*************************!*\
  !*** ./src/lib/core.ts ***!
  \*************************/
/*! exports provided: Text, Input, Div, Image */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _core_Text__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./core/Text */ "./src/lib/core/Text.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Text", function() { return _core_Text__WEBPACK_IMPORTED_MODULE_0__["default"]; });

/* harmony import */ var _core_Input__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./core/Input */ "./src/lib/core/Input.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Input", function() { return _core_Input__WEBPACK_IMPORTED_MODULE_1__["default"]; });

/* harmony import */ var _core_Div__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./core/Div */ "./src/lib/core/Div.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Div", function() { return _core_Div__WEBPACK_IMPORTED_MODULE_2__["default"]; });

/* harmony import */ var _core_Image__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./core/Image */ "./src/lib/core/Image.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Image", function() { return _core_Image__WEBPACK_IMPORTED_MODULE_3__["default"]; });
...
/* harmony import */ var _Pipe__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Pipe */ "./src/lib/Pipe.ts");

class Div extends _Pipe__WEBPACK_IMPORTED_MODULE_0__["default"] {
    constructor(classes, children) {
        super('pipe', classes, children);
    }
    get input() {
        return Object.assign({}, ...Object.values(this.children).map(c => {
            return c.input;
        }));
    }
    get output() {
...
class Image extends _Pipe__WEBPACK_IMPORTED_MODULE_0__["default"] {
    constructor(src, classes, children) {
    ...
    get output() {
        return {
            src: new rxjs__WEBPACK_IMPORTED_MODULE_1__["Subscriber"]((newSrc) => {
...
/* harmony import */ var _Pipe__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../Pipe */ "./src/lib/Pipe.ts");



class Input extends _Pipe__WEBPACK_IMPORTED_MODULE_2__["default"] {
    constructor() {
        super('input');
    }
    get input() {
        return {
            input: Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["fromEvent"])(this.element, 'input').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])((e) => e.target.value)),
        };
    }
}
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm5/index.js");
/* harmony import */ var _Pipe__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Pipe */ "./src/lib/Pipe.ts");


class Text extends _Pipe__WEBPACK_IMPORTED_MODULE_1__["default"] {
    constructor() {
        super('p');
    }
    get output() {
        return {
            text: new rxjs__WEBPACK_IMPORTED_MODULE_0__["Subscriber"]((text) => {
